...
def get_output_music_to_music_change_music_query(music_query_path:str, path:str="notebooks/clamp/model/inference/", top_n:int = 1, model:str = "sander-wood/clamp-small-512", cwd: str = "notebooks/clamp/model/")-> List[Tuple[str, float, float]]:
    """
