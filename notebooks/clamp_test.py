...
def main():
    ...
    cw.change_clamp_txt_keys(["It is funny.", "It is sad.", "It is about love.", "It is composed for movie.", "Clint Eastwood played in film with this music.", "Genre of this music is Jazz", "Genre of this music is Reggae.", "Genre of this music is Rock.", "Genre of this music is Classic.", "This music could be in mafia movie."])
